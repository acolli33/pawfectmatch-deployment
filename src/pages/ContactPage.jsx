  ...
  return (
    <>
      ...
      <div style={styles.container} className="contact-container">
        ...
        <nav style={styles.leftPane} className="contact-left-pane" aria-label="Conversations">
        ...
        <main style={styles.rightPane} className="contact-right-pane" aria-label="Chat window">
        ...
        {showNewChatModal && (
          <div style={styles.modalOverlay} role="dialog" aria-modal="true" aria-label="Start new conversation">
            <div style={styles.modal}>
              <header style={styles.modalHeader}>
                <h2 style={styles.modalTitle}>Start New Conversation</h2>
              </header>
              <div style={styles.modalList}>
                {availableAnimals.length === 0 ? (
                  ...
                  availableAnimals.map(animal => (
                    ...
                    >
                      <img src={animal.primary_photo_url} alt={animal.name} style={styles.animalImage} />
                      <div style={{ flex: 1, textAlign: "left" }}>
                        <div style={{ fontWeight: "600", color: "#2C2C34" }}>{animal.name}</div>
                        <div style={{ fontSize: "13px", color: "#595959", marginTop: "2px" }}>{animal.breed}</div>
                      </div>
                    </button>
                  ))
                )}
              ...
              <footer style={styles.modalFooter}>
                <button onClick={() => setShowNewChatModal(false)} style={styles.closeButton}>Close</button>
              </footer>
            </div>
          </div>
        )}
